...
public class GoogleRouteRequestAsyncTaskTest {
    ...
    private String getUrlFromMethod(GoogleRouteRequestAsyncTask googleRouteRequestAsyncTask, String origin, String destination) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        Method buildURLMethod = googleRouteRequestAsyncTaskClass.getDeclaredMethod("buildUrl", String.class, String.class);
        buildURLMethod.setAccessible(true);

        return (String) buildURLMethod.invoke(googleRouteRequestAsyncTask, origin, destination);
    }
}